...
class AgentPlatformApiClient:
    ...
    def options(self) -> dict[str, Any]:
        return self._request_json("GET", "/api/v2/model-catalog/options", params={"scenario": "chat", "refresh": "true"})
    ...
    def persistent_state(self, agent_id: str) -> dict[str, Any]:
        return self._request_json("GET", f"/api/v2/agent-studio/agents/{agent_id}/persistent-state", params={"limit": "500"})

    def archive_agent(self, agent_id: str) -> dict[str, Any]:
        return self._request_json("POST", f"/api/v2/agent-studio/agents/{agent_id}/archive")

    def purge_agent(self, agent_id: str) -> dict[str, Any]:
        return self._request_json("DELETE", f"/api/v2/agent-studio/agents/{agent_id}/purge")
