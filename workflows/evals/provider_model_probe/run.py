...
from ade_api.llm.provider_model_probe import probe_source_chat_models, probe_source_label_models
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--source-id", required=True, help="Configured source id from config/model-router/sources.json.")
    parser.add_argument(
        "--mode",
        default="chat-probe",
