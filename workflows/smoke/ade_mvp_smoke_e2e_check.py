...
def main() -> None:
    ...
    try:
        with httpx.Client(
            ...
            details_response = http.get(f"/api/v2/agent-studio/agents/{agent_id}")
            ...
            metadata_response = http.get("/api/v2/prompt-center/catalog")
            ...
            persona_response = http.patch(
                f"/api/v2/agent-studio/agents/{agent_id}/memory/persona",
            ...
            if artifacts:
                ...
                if artifact_id:
                    artifact_read_response = http.get(
                        f"/api/v2/test-center/runs/{run_id}/artifacts/{artifact_id}?max_lines=120"
                    )
