...
ADE_API_API_BASE_URL = os.getenv("ADE_API_API_BASE_URL", "http://127.0.0.1:8284")
ADE_API_API_CLIENT_TIMEOUT_SECONDS = float(os.getenv("ADE_API_API_CLIENT_TIMEOUT_SECONDS", "180"))
...
def main() -> None:
    ...
    try:
        with httpx.Client(
            ...
            timeout=ADE_API_API_CLIENT_TIMEOUT_SECONDS,
            ...
            scenario_guard = http.post("/api/v2/agent-studio/agents", json=guard_payload)
