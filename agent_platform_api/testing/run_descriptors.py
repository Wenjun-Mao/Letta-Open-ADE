...
def _build_platform_api_e2e_check(_: Path, __: RunOptions) -> list[str]:
    return [sys.executable, "tests/checks/platform_api_e2e_check.py"]


def _build_ade_mvp_smoke_e2e_check(_: Path, __: RunOptions) -> list[str]:
    return [sys.executable, "tests/checks/ade_mvp_smoke_e2e_check.py"]
...
RUN_DESCRIPTORS: Final[dict[str, TestRunDescriptor]] = {
    "platform_api_e2e_check": TestRunDescriptor(
        ...
        command_builder=_build_platform_api_e2e_check,
