...
type ModelOption = {
  ...
  sampling_defaults?: Partial<Record<SamplingField, number | null>>;
  scenario_sampling_defaults?: Partial<Record<SamplingScenario, Partial<Record<SamplingField, number | null>>>>;
};
...
export function formatModelOptionLabel(option: ModelOption, unavailableSuffix = ""): string {
