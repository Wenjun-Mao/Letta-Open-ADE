export const LABEL_LAB_COPY = {
  en: {
    ...
    capabilityJsonObject: "JSON Object (locally validated)",
    ...
    notesThree: "This route is stateless and does not create or update Agent Studio state.",
  ...
  zh: {
    ...
    capabilityJsonSchema: "JSON Schema",
    capabilityJsonObject: "JSON 对象（本地校验）",
    ...
    notesThree: "该路径是无状态的，不会创建或更新 Agent Studio 状态。",
