...
- Native qualification: `agent-runtime-v3-acceptance-fields.tsx` selects role-compatible fingerprinted deployments from Model Catalog; evidence remains in the generic artifact viewer for this first slice.
