export const COMMENT_LAB_COPY = {
  en: {
    ...
    enableThinkingHint: "Supported models may separate reasoning. DeepSeek defaults to thinking and keeps it out of the published reply.",
  ...
  zh: {
    ...
    enableThinkingHint: "部分模型支持独立推理；DeepSeek 默认启用 Thinking，推理不会进入发布内容。",
    temperature: "Temperature",
    topP: "Top P",
    topK: "Top K",
    userInput: "输入文本",
