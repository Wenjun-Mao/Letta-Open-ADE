export const COMMENT_LAB_COPY = {
  en: {
    ...
    enableThinkingHint: "Supported models may separate reasoning. DeepSeek requires thinking and keeps it out of the published reply.",
    deepseekThinkingRequired: "DeepSeek requires thinking for this development lane.",
    ...
    notesOne: "This route is stateless and does not create or modify Agent Studio state.",
  ...
  zh: {
    ...
    enableThinkingHint: "部分模型支持独立推理；DeepSeek 开发通道必须启用，推理不会进入发布内容。",
    deepseekThinkingRequired: "DeepSeek 开发通道必须启用 Thinking。",
    temperature: "Temperature",
    topP: "Top P",
    topK: "Top K",
    userInput: "输入文本",
    ...
    rawJsonView: "原始 JSON",
    notesTitle: "执行说明",
    notesOne: "该路径为无状态，不会创建或修改 Agent Studio 状态。",
