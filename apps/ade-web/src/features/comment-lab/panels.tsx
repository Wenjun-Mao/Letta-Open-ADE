  ...
  return (
    <div className="card studio-panel">
      ...
      <div className="form-grid" style={{ marginTop: 10 }}>
        ...
        <NumberField label={copy.temperature} value={form.temperature} onChange={controller.setTemperature} disabled={disabled || (deepseek && form.enableThinking)} min={0} max={2} step={0.1} />
