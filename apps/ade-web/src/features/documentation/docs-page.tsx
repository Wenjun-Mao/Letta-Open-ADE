  ...
  return (
    <section>
      ...
      <div className="card">
        ...
        <ul className="list">
          <li>{copy.openapiArtifact}: docs/openapi/ade-api-openapi.json</li>
          <li>{copy.frontendArtifact}: apps/ade-web/public/openapi/ade-api-openapi.json</li>
          <li>{copy.chineseOpenapiArtifact}: docs/openapi/ade-api-openapi-zh.json</li>
