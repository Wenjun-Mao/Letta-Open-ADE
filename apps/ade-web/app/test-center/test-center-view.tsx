import type { CreateTestRunPayload, PlatformArtifact, PlatformRunRecord } from "../../lib/api";
...
type Props = {
  ...
  selectedRunSummary: PlatformRunRecord | null;
  selectedRun: PlatformRunRecord | null;
