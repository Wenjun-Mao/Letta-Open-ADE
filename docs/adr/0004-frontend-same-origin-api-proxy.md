...
- The Next.js server proxies those paths to the Agent Platform API using runtime
...
repository guardrail rejects reintroduction of a public Agent Platform base URL.
