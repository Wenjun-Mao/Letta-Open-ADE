...
class CommentingGenerateRequest(BaseModel):
    ...
    prompt_key: str = Field(default="comment_v20260418", description="Comment Lab prompt key from `/api/v2/model-catalog/options?scenario=comment`.")
    persona_key: str = Field(default="comment_linxiaotang", description="Comment Lab persona key from `/api/v2/model-catalog/options?scenario=comment`.")
