...
class LabelingGenerateRequest(BaseModel):
    ...
    prompt_key: str = Field(default="label_generic_entities_v1", description="Label Lab prompt key from `/api/v2/model-catalog/options?scenario=label`.")
    schema_key: str = Field(default="label_entity_groups_v1", description="Label Schema Center key from `/api/v2/model-catalog/options?scenario=label`.")
    model_key: str = Field(
        ...,
