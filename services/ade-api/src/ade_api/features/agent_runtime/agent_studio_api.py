...
async def archive_definition(
    definition_id: str, service: AgentRuntimeServiceDependency
):
    return await call_runtime(
...
async def archive_subject(subject_id: str, service: AgentRuntimeServiceDependency):
    return await call_runtime(
...
async def restore_subject(subject_id: str, service: AgentRuntimeServiceDependency):
    return await call_runtime(
