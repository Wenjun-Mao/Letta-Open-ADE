...
from ade_api.platform.dependencies import REVISION_LOG_DIR, REVISION_LOG_FILE
from ade_api.features.prompt_center.codec import first_non_empty_line
...
def read_prompt_persona_revisions(
    *,
    ...
    try:
        with _REVISION_LOG_LOCK:
            lines = REVISION_LOG_FILE.read_text(
