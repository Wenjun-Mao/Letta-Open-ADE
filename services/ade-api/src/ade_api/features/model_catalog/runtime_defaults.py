...
from ade_api.platform.contracts import CommentingTaskShape
...
def commenting_runtime_defaults(
    commenting_service: RuntimeDefaultsProvider,
) -> ApiCommentingRuntimeDefaultsResponse:
...
def labeling_runtime_defaults(
    labeling_service: RuntimeDefaultsProvider,
) -> ApiLabelingRuntimeDefaultsResponse:
