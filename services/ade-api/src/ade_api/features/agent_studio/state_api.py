...
from ade_api.platform.dependencies import LettaClientDependency
...
from ade_api.platform.serialization import (
    normalize_text,
    serialize_message,
    to_jsonable,
)
...
async def api_get_agent_persistent_state(
    agent_id: str,
    client: LettaClientDependency,
    limit: int = 120,
