...
from ade_api.auth import PlatformPrincipal, PlatformRole, require_operator
from ade_api.dependencies import commenting_service
from ade_api.feature_flags import ensure_platform_api_enabled
from ade_api.template_options import normalize_scenario, persona_content_map, prompt_content_map
from ade_api.models.commenting import ApiCommentingGenerateResponse, CommentingGenerateRequest
from ade_api.openapi_metadata import TAG_COMMENT_LAB
