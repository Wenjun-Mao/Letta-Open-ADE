...
from ade_api.agent_context import is_datetime_query, runtime_datetime_system_hint
from ade_api.auth import require_operator
...
from ade_api.models.agents import ApiChatResponse, ApiOptionsResponse, ChatRequest
from ade_api.openapi_metadata import TAG_AGENT_STUDIO, TAG_MODEL_CATALOG
from ade_api.options import (
    DEFAULT_EMBEDDING,
...
async def api_chat(agent_id: str, request: ChatRequest):
    ensure_platform_api_enabled()
