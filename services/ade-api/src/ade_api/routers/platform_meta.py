...
from ade_api.agent_access import ensure_agent_not_archived
from ade_api.auth import PlatformPrincipal, require_admin, require_operator
from ade_api.capability_validation import missing_platform_capabilities
from ade_api.dependencies import agent_platform, client, custom_tool_registry
from ade_api.feature_flags import ensure_platform_api_enabled, is_truthy, platform_api_enabled
from ade_api.revision_log import read_prompt_persona_revisions
from ade_api.template_options import (
...
from ade_api.models.platform import (
...
from ade_api.models.templates import (
    ApiPromptPersonaMetadataResponse,
    ApiPromptPersonaRevisionsResponse,
)
from ade_api.openapi_metadata import TAG_MODEL_CATALOG, TAG_PROMPT_CENTER, TAG_TOOL_CENTER
from ade_api.options import model_catalog
