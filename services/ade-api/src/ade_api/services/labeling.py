...
from ade_api.clients.openai_chat import (
    OpenAIChatClient,
...
class LabelingService:
    ...
    def runtime_defaults(self) -> dict[str, Any]:
        ...
        return {
            "max_tokens": self._clamp_max_tokens(settings.label_lab_max_tokens),
            "timeout_seconds": self._clamp_timeout_seconds(
                settings.label_lab_timeout_seconds
            ),
            "repair_retry_count": self._clamp_repair_retry_count(
                settings.label_lab_repair_retry_count
            ),
            "temperature": self._clamp_temperature(settings.label_lab_temperature),
            "top_p": self._clamp_top_p(settings.label_lab_top_p),
            "top_k": self._clamp_top_k(settings.label_lab_top_k),
        }
