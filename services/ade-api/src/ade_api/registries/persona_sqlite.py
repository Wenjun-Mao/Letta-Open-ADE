...
from ade_api.registries.persona_exchange import (
    PersonaConflictPolicy,
    export_personas_jsonl,
    export_personas_markdown,
    import_personas_jsonl,
)
from ade_api.registries.persona_records import PersonaRecordMapper
from ade_api.registries.persona_rules import PersonaRules
from ade_api.registries.persona_seed import PersonaSeedProjection
from ade_api.registries.persona_store import PersonaSqliteStore
    ...
    def __init__(
        ...
        *,
        ...
        self.seed_jsonl_path = (
            seed_jsonl_path
            or self.project_root / "content" / "personas" / "personas.jsonl"
        ).resolve()
