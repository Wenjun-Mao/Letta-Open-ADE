...
SUMMARY_TRANSLATIONS = {
    ...
    "Get Agent Runtime paired baseline evidence": "获取智能体运行时配对基线证据",
    "List Agent Runtime paired baseline comparisons": "列出智能体运行时配对基线对比",
...
TITLE_TRANSLATIONS = {
    ...
    "Legacy Rounds Passed": "旧运行时通过轮数",
    "Native Not Worse Than Legacy": "原生运行时不落后于旧运行时",
    "Native Rounds Passed": "原生运行时通过轮数",
    "Pass Rate": "通过率",
    "Passed": "是否通过",
    "Purged": "已清理",
    "Ready": "已就绪",
