...
SUMMARY_TRANSLATIONS = {
    ...
    "Create an atomic native-runtime preview session": "创建原子化原生运行时预览会话",
...
DESCRIPTION_TRANSLATIONS = {
    "Disabled-by-default ADE-owned agent runtime preview APIs.": "默认禁用的 ADE 自有智能体运行时预览 API。",
    "Create the bounded resources needed by the separate native pilot.": "创建独立原生试点所需的边界化资源。",
...
TAG_TRANSLATIONS = {
    "Agent Runtime v3 Preview": "智能体运行时 v3 预览",
    "Agent Studio": "智能体工作台",
    "Comment Lab": "评论实验室",
    "Label Lab": "标注实验室",
    "Prompt Center": "提示词中心",
